# Contributing to can-jsx

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/canjs/can-jsx) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-jsx, you can start by going to its [fork page](https://github.com/canjs/can-jsx/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-jsx
```
